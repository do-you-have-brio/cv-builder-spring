...
public class AuthController {
    ...
    public ResponseEntity<Map<String, String>> createUser(@RequestBody CreateUserDto dto) throws EmailExistsException {
        var user = authService.createUser(dto);

        Map<String, String> responseBody = new HashMap<>();
        responseBody.put("message", "Usuário com email " + user.getEmail() + " criado com sucesso.");
